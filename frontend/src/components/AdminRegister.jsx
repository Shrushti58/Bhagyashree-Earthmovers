...
export default function AdminRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to admin dashboard after 2 seconds without page reload
      setTimeout(() => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 sm:px-6 py-12 transition-colors duration-300 ${
      ...
      {/* Orange glow */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 rounded-full blur-3xl opacity-20 bg-primary"></div>
